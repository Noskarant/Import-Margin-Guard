...
import type { CostAllocationMethod, ScenarioFxRates } from '@/features/scenarios/lib/calculate';
...
function normalizeFxRates(value: unknown): ScenarioFxRates {
...
function mapScenarioRow(row: any): DemoScenario {
  ...
  return {
    ...
    fxRates: normalizeFxRates(overrides.fxRates),
    ...
    marginCoverageThreshold: Number(overrides.marginCoverageThreshold ?? 0.8),
  };
}
