...
const copy = {
  ...
  fr: {
    ...
    noScenarioNote: 'Aucune note de scénario n’a encore été ajoutée. Utilisez les notes du builder pour expliquer l’intention métier de chaque option.',
    ...
    noSavingsText: 'Le meilleur scénario actuel ne réduit pas le landed cost total par rapport à la baseline. Vérifiez les hypothèses avant de l’utiliser comme recommandation.',
    ...
    lowMarginText: 'La marge brute estimée est de {{margin}}%, ce qui peut être trop faible selon votre seuil cible.',
    costIncreaseTitle: 'Hausse de coût significative',
    costIncreaseText: 'La meilleure option actuelle augmente encore sensiblement le landed cost par unité par rapport à la baseline. Revoyez achat, transport et droits.',
